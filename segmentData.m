function dataSegStruct = segmentData(dataNorm,winSize,fs)
...
numVars = size(dataNorm,2); %columns are variables: accS1x, gyro...labels
                             
%also segments labels!!
for var = 1:numVars
    dataSegStruct.dataSeg{var} =buffer(dataNorm(:,var),samplesPerWindow)';
end
